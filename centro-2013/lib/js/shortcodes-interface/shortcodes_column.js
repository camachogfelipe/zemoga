				...
				<div id="shortcodes-column-container" class="shortcodes-container">\
					<div class="left">\
						...
						<select name="celta_column_size" id="celta_column_size">\
							...
							<option value="two-fifth">Two Fifths</option>\
							<option value="three-fifth">Three Fifths</option>\
							<option value="four-fifth">Four Fifths</option>\
							...
							<option value="five-sixth">Five Sixths</option>\
					...
					<div class="clear"></div>\
					<div class="left">\
						<label for="celta_column_title">Column Title (Optional)</label>\
						<input type="text" id="celta_column_title" name="celta_column_title" value="" />\
						<small>Insert the title of the column.</small>\
					</div>\
					<div class="right">\
						<label for="celta_column_subtitle">Column Subtitle (Optional)</label>\
						<input type="text" id="celta_column_subtitle" name="celta_column_subtitle" value="" />\
						<small>Insert the subtitle of the column.</small>\
					</div>\
					<div class="clear"></div>\
					<div class="full">\
						<p class="submit">\
